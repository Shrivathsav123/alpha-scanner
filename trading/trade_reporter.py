...
def build_trade_report(action, ticker, price, shares, reasoning,
    ...
    cover_data = [[
        Table([
            [Paragraph("ALPHA TERMINAL", ParagraphStyle("at", fontSize=9,
    ...
    story.append(Paragraph(
        "This report is generated by the ALPHA autonomous trading system for internal "
...
def send_trade_report(action, ticker, price, shares, reasoning,
    ...
    try:
        ...
        filename = f"ALPHA_{action}_{ticker}_{now}.pdf"

        caption = (
            f"ALPHA TRADE REPORT\n"
